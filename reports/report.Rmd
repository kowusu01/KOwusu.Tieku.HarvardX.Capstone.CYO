...
- This project was developed and tested in Windows. It has been tested under __Ubuntu 18.04.3 LTS__ and __Ubuntu 20.04.2 LTS__ and the script ran successfully. It has not been tested under any other operating system.  
...
- create a subfolder R under the base folder and copy the main script ( __adults_income.R__ ) to that folder  
