...
```{r 01_source_include, echo=FALSE, message=FALSE, include=FALSE}
  ...
  # this is later split into training_set_final and test_set_final
  ...
  # the original validation set, used for the final validation 
  adult_income_validation  <- readRDS(file.path( rda_path, "adult_income_validation.rda"))
  
  # this is a copy of the adult_income_train dataframe, modified specifically for visualization
  ...
  # load final model performance stats
